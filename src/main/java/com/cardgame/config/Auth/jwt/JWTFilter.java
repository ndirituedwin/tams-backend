...
//
//import com.cardgame.CardGameApplication;
...
////      AuthenticationApplication.logger.info("Security exception {}", e.getMessage());
//      CardGameApplication.logger.info("Security exception {}", e.getMessage());
