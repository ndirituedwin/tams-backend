...
//                        playersuidset.add(userbestcard.getUser().getUID());
//
...
//            }
//        });
//        List<Long> playersuids=new ArrayList<>(playersuidset);
//
//
...
//
//
//            return new Winninghandresponse("PLayer two uid 199 has won the game "+uid199matchlist+" against player one uid 140 "+uid140matchlist,"The winning hand index "+uid199matchlist,PLAYER_TWO,playersuids.get(1));
//        }
//        if (!uid140matchlist.isEmpty() && uid199matchlist.isEmpty() ){
...
//
//
//            return new Winninghandresponse("Player one uid 140 has won "+uid140matchlist+" against player two uid 199 "+uid199matchlist,"The winning hand index "+uid140matchlist,PLAYER_ONE,playersuids.get(0));
//
...
//            return new Winninghandresponse("PLayer two uid 199 has won "+uid199matchlist+" against uid 140 "+uid140matchlist,"The winning hand index "+uid199matchlist,PLAYER_TWO,playersuids.get(1));
//
//        }
//
//
...
//
//
//                return new Winninghandresponse("THe second player uid 199 has won the game:This is when both cards are equal "+uid199matchlist+" and uid 199 cards are "+Arrays.toString(uid199usercards)+" against uid 140 "+uid140matchlist+" whose usercards are "+Arrays.toString(uid140usercards),"The winning hand idex "+uid199matchlist,PLAYER_TWO,playersuids.get(1));
//            }
//        }
//        return null;
//
